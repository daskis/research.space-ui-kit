...
import {IIconButtonProps} from "./IconButton.props.ts";
    ...
    return (
        <button
            ...
            className={classNames(cls.button, {
                ...
                [cls.icon_primary]: iconColor === "primary",
                [cls.icon_secondary]: iconColor === "secondary",
                [cls.icon_success]: iconColor === "success",
                [cls.icon_warning]: iconColor === "warning",
                [cls.icon_danger]: iconColor === "danger",
                [cls.icon_info]: iconColor === "info",
                [cls.icon_link]: iconColor === "link",
                [cls.icon_white]: iconColor === "white",
                [cls.icon_black]: iconColor === "black",
