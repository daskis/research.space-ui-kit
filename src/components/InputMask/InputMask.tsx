...
import { InputMask as MaskInput } from '@react-input/mask';
import { IInputMaskProps } from './InputMask.props.ts';
import { classNames } from '@helpers';
import { useDebounce } from '@hooks';

export const InputMask = forwardRef<HTMLInputElement, IInputMaskProps>((
    {
        mask,
        replacement,
        showMask = true,
